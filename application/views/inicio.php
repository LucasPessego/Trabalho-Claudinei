...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" src="<?php echo base_url('img/pow.jpg');?>" type="image/x-icon">
...
?>
    <div class="login-box">
        <div class="logo">
        <center>
             <img id="profile-img"  src="<?php echo base_url('img/pow.jpg');?>" width="200" heigth="60">
             </center>
             <br>
            <small><h4>Sistema Persch</h4></small>
        </div>
        <div class="card">
            <div class="body">
