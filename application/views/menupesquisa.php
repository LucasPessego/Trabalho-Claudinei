      ...
      <nav class="navbar">
         <div class="container-fluid">
            <div class="navbar-header">
               ...
               <!-- <img src="pow.jpg" width="180" height="65" alt="User" /> -->
            </div>
         ...
         <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
               ...
               <div class="info-container">
                  <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">PERSCH</div>
            ...
            <div class="menu">
               <ul class="list">
                  ...
                  <li>
                        ...
                        <li>
                           <a href="<?php echo site_url("pesquisas/Pesquisaforma")?>">Forma de Pagamento</a>
                        </li>
                        <li>
                           <a href="<?php echo site_url("pesquisas/pesquisaestado")?>">Estados</a>
                        </li>
                        <li>
