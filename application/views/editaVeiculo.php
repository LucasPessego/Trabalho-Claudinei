   ...
   <body>
      ...
      <?php
         ...
         WHERE idveiculo='$Vcodigo'";
               ...
               list($Vcodigo,$Vmodelo,$Vano,$Vplaca,$Vcliente) = mysqli_fetch_row($editar);                                    
                  ...
                  <form class="form-horizontal" name="formulario"  action="../atualiza/atualizarVeiculo"  method="POST" role="form">
                     ...
                     <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                           <div class="form-group">
                              <div class="form-line">
 <input type="text" id="modelo" name="modelo" class="form-control" placeholder="Informe o Modelo"value="<?php echo $Vmodelo?>"disabled>
                              </div>
                           </div>
                        </div>
                     </div>
 ...
 <input type="integer" id="ano" name="ano" class="form-control" placeholder="Informe o ano do veiculo"value="<?php echo $Vano?>"disabled>
              ...
              <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                           <div class="form-group">
                              <div class="form-line">
 <input type="text" id="placa" name="placa" class="form-control" placeholder="Informe a placa do veiculo"value="<?php echo $Vplaca?>"disabled>
                              </div>
                           </div>
                        </div>
                     </div>
